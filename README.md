...
<div align="center">
  ...
  <h3 align="center">Build a Trello‑clone App with Next.js, TailwindCSS, Supabase, Clerk, dnd‑kit & shadcn</h3>
  <br />
</div>
...
In this application, I have build a production‑ready **Trello‑Style App** using **Next.js**, **Supabase**, **Clerk**, **dnd‑kit**, **shadcn** and **TailwindCSS**. The functionalities includes **real‑time data**, **authentication & billing**, **drag‑and‑drop**, and **filtering**.
...
- Ability to create Team or Organization and add multiple users to the board and be able to access the boards by multiple users
- Ability to add comments and attachments to the tasks
- Ability to filter by assignee
- Bug fixes
...
```bash
git clone https://github.com/jeckmabasa/trello-clone-app.git
cd trello-clone-app
npm install
```
